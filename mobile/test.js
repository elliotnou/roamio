...
var supabase = (0, supabase_js_1.createClient)(process.env.EXPO_PUBLIC_SUPABASE_URL || '', process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY || '');
function checkInsertFailure() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, authData, authErr, _b, trip, tripErr;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    _b = _c.sent(), trip = _b.data, tripErr = _b.error;
