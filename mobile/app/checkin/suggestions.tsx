      ...
      <View style={s.container}>
        ...
        <View style={s.header}>
          ...
          <View>
            ...
            <Text style={s.headerSub}>Swipe or tap arrows to browse</Text>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  toastText: { color: C.white, fontWeight: '600', fontSize: 14 },
  ...
  headerTitle: { fontSize: 18, fontWeight: '700', color: C.fg },
  headerSub: { fontSize: 12, color: C.placeholder },

  cardStack: { height: 420, marginBottom: 16 },
  card: {
    position: 'absolute', width: CARD_W, height: 400, borderRadius: 24, overflow: 'hidden',
  },
  ...
  energyBadgeText: { color: C.white, fontSize: 12, fontWeight: '600' },

  cardBottom: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 24 },
  cardTitle: { color: C.white, fontSize: 20, fontWeight: '700', marginBottom: 8 },
  cardDesc: { color: 'rgba(255,255,255,0.8)', fontSize: 14, lineHeight: 20, marginBottom: 12 },
  ...
  dotActive: { width: 24, backgroundColor: C.sage },
  ...
  chooseBtnText: { color: C.white, fontSize: 14, fontWeight: '600' },
  skipBtn: { alignItems: 'center', paddingVertical: 8 },
  skipText: { color: C.secondary, fontSize: 14, fontWeight: '500' },
});
